    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="second-section-service.html"><i class="fa fa-edit"></i> Edit</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-xs-6">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <!-- action="second_sec_edit" method="post" -->
            <form id="myForm" >
              <div class="box-body">
                <div class="form-group">
                  <label>Seccond Section Headding</label>
                  <input type="text" class="form-control" id="fh" name="firstHeadding" required>
                </div>
                <div class="form-group">
                  <label>Seccond Section Sub Headding</label>
                  <input type="text" class="form-control" id="sh" name="secHeadding" required>
                </div>
                <div class="form-group">
                  <label>Seccond Section Paragraph</label>
                  <input type="text" class="form-control" id="th" name="paragraph" required>
                </div>
              </div>
              <!-- /.box-body -->
