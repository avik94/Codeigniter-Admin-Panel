      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="banner_edit"><i class="fa fa-edit"></i> Edit</a></li>
        ...
        <div class="col-lg-8 col-xs-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Put Content and Image to update Site Banner Section</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open_multipart('banner_edit');?>
            <form id="myForm" action="banner_edit" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label>First Headding</label>
                  <input id="fH" type="text" class="form-control" name="firstHeadding" required>
                </div>
                <div class="form-group">
                  <label>Seccond Headding</label>
                  <input id="sH" type="text" class="form-control" name="secHeadding" required>
                </div>
                <div class="form-group">
                  <label>Third Headding</label>
                  <input id="tH" type="text" class="form-control" name="thirdHeadding" required>
                </div>
                <div class="form-group">
                  <label>File input</label>
                  <input id="fI" type="file" name="imageName" value="3" required>

                  <p class="help-block">Upload Background Image Here(in .jpg/.png Format ).</p>
                  <?php if(isset($error)){
                    echo $error;
                  }?>
                </div>
