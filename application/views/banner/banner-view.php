      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>banner_view"><i class="fa fa-eye"></i> View</a></li>
          </ul>
        </li>
        <!-- first menu end  -->
        <!-- seccond menu start -->
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="<?php echo base_url(); ?>second_sec_edit"><i class="fa fa-edit"></i> Edit</a></li>
